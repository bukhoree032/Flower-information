                    ...
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><i class="fas fa-eye pointer" onclick="window.location='{{ route('manage.page.detail_farme',$value->id_db ?? null) }}'"></i> <i class="fas fa-edit pointer" onclick="window.location=''" style="margin-left: 15px" ></i><i class="far fa-trash-alt" style="margin-left: 15px"></i></td>
                            </tr>    
                            @endforeach
                        </tbody>
                    </table>
