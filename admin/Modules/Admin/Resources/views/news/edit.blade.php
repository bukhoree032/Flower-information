                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-12">
                                ...
                                <input name="n_title" type="text"  class="form-control" placeholder="ใส่ชื่อดอกไม้" value="{{ $result->n_title }}"/>
                                <span class="form-text text-muted">กรุณาใส่หัวข้อของข่าวกิจกรรม</span>
                            </div>
                            <div class="col-lg-12">
                                <label>รายละเอียดข่าว :</label>
                                <input name="n_details" type="text" class="form-control" placeholder="ใส่ชื่อสามัญ" value="{{ $result->n_details }}"/>
