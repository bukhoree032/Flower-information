    ...
    <div class = "card-wrapper margin-card">
        <div class = "card">
          ...
          <div class = "product-imgs">
            <div class = "img-display">
              <div class = "img-showcase">
                <img src = "https://ออกแบบร้าน.com/wp-content/uploads/2019/12/024-5-1024x683.jpg" alt = "shoe image">
          ...
          <div class = "product-content">
            <h2 class = "product-title">ชื่อร้านค้า</h2>
                ...
                <h3>ดอกไม้ในร้าน: </h3>
                <p>ดอกราชพฤกษ์ (คูน) *ดอกไม้ประชำชาติไทย
                    ดอกปีบ (กาสะลอง) *ดอกไม้ประจำวิชาชีพ พยาบาล
                    ดอกขจร(สลิด) *เป็นไม้มงคลเชื่อว่าบ้านใดปลูกไว้ บ้านนั้นจะมีชื่อเสียงขจรขจายดังชื่อ
                    ดอกกล้วยไม้ ช้างกระ *ดอกกล้วยไม้ เป็นดอกไม้ประจำวิชาชีพ ครู
                    ดอกอัญชัญ ...
                    ดอกแคแสด
                    ดอกยี่หุบ
                    ดอกหางนกยูง</p>
